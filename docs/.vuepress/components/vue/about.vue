<template>
  <div>
    ...
    <ul>
      ...
      <Content slot-key="code-vuex5" />
    </ul>
    <h4>vuex 中数据存储 localStorage</h4>
    <p>
    ...
    <Content slot-key="code-vuex6" />
    <Content slot-key="title-vuex6" />
